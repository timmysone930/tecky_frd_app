...
import {
    View, Text, SafeAreaView, ScrollView, FlatList, StyleSheet
} from 'react-native';
...
const Item = (props: any) => (
    <TouchableOpacity style={styles.drListCard} onPress={()=>{props.navigate.navigation.navigate('醫生詳情')}}>
        {/* Icon */}
        <View><Icon name="user-circle" size={60} color="#900" /></View>
...
export const DrList: React.FC = (prop:any) => {
    ...
    const renderItem = (props: any) => (
        <Item name={props.item.name} address={props.item.address} gender={props.item.gender} type={props.item.type} navigate={prop} />
    );
