...
export const LoginPage = (props: any) => {
  ...
  const previousPage = useSelector(
    (state: any) => state.setDoctorID.currentPage,
  );
  ...
  const onSMSPress = async (inputData: any) => {
    ...
    // Fetching
    try {
      const res: any = await getLoginSMS({
      ...
      <ScrollView>
        <View style={styles.logoStyle}>
          <Image
            ...
            resizeMethod="scale"
            source={{
              uri: `https://telemedicine-web.vercel.app/swindonLogoBigger.jpg`,
            }}
