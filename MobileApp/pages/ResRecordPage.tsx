...
export const ResRecordPage = (props: any) => {
    ...
    return (
        <SafeAreaView style={[backgroundStyle, { flex: 1 }]}>
            ...
            {recordData.isSuccess? recordData.data.length !== 0 ? <ResRecordComponent data={recordData.data} props={props} refreshing={refreshing} onRefresh={onRefresh} />:<Text style={{ textAlign: 'center', fontSize: 17, margin: 20 }}>沒有預約記錄</Text> 
