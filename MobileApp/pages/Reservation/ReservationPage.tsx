...
import { View, Text, SafeAreaView, ScrollView, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, RefreshControl } from 'react-native'
                        ...
                        <View style={[styles.pageMargin, { paddingBottom: '15%' }]}>
                            ...
                            >
                                <Text style={styles.subTitle}>
                                    暫定問診費用： ${docData.video_diag_fee === 0 ? 0 : docData.video_diag_fee || 9999}
                                </Text>
