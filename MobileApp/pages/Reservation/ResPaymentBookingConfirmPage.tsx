...
import {
  useGetReservedSessionByIdQuery,
  useGetRosterByIdQuery,
} from '../../API/DoctorAPI';
import {
  usePostPatientRegisterMutation,
  usePutHoldSessionMutation,
} from '../../API/PatientAPI';
      ...
      <ScrollView
        ...
        <View>
          ...
          <Text style={[styles.subTitle, styles.ph_10, {marginLeft: 5}]}>
            預約時段:{' '}
            {`${rosterSession.currentData['start_at']} - ${rosterSession.currentData['end_at']}`}
          </Text>
