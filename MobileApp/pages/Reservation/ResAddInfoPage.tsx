...
export const ResAddInfoPage: React.FC = (props: any) => {
  ...
  const onSetModalVisible = (status: boolean) => {
  ...
  const isUploaded = async (data: AddInfoSubmitType) => {
    ...
    if (response === null) {
      ...
      props.navigation.navigate('預約須知', {
  ...
  useEffect(() => {
    ...
    const updateUserInfo = async () => {
      if (userData.isSuccess) {
        ...
        await setValue('name_en', props.route.params.name);
      }
    };
