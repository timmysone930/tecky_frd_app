        ...
        <SafeAreaView style={[backgroundStyle, { flex: 1 }]}>
            <ScrollView contentInsetAdjustmentBehavior="automatic" style={{ backgroundColor: 'white', padding: 15, paddingTop: 25, marginBottom: 2, }}>
                <View style={[backgroundStyle, { flex: 1, marginBottom: 15 }]}>
                    ...
                    條款及細則
                    • 德信醫療集團（德信醫療）的醫生透過經網站、客戶服務中心、及診所直接的預約安排，於線上以視像會議的方式提供遠程 會診服務（視像會診）。
                    • 視像會診服務恕不接受醫療券使用。
                    • 視像會診服務受下述條款及細則約束。
                    • 視像會診服務在任何情況下都並非用以取代面對面問診。如您對其準確性、有用性或適用性存在猶豫，德信醫療建議您安排醫生面對面問診或到訪醫院的急診科尋求進一步醫療諮詢。
                    • 2019 冠狀病毒測試：若果檢測結果有上報的需要，或患者的情況有可能為公共衛生帶來隱憂，德信醫療將根據衞生防護中心的指示上報有關個案。患者將會收到通知及被安排送往醫管局豁下設施作進一步診治。
                   ...
                   設備及連接要求
                    ...
                    • 您理解並知道視像會診服務並不包括任何身體檢查。所有會診服務均以遙距方式進行。醫生提供的意見將完全基於患者與有關醫生口頭上的溝通以及您所提供的其他資料。無論在任何情況及環境，醫生都不會對以下情況承擔任何責任，包括 i) 錯誤診斷；ii) 錯誤判斷；iii) 錯誤闡釋；iv) 錯誤理解；v) 處方治療及建議無效；vi) 醫生所提供的建議及處方在您居住的國家無效；vii) 醫生處方或建議的治療和藥物因各種原因無法應用。
                   ...
                   藥物及治療
                    ...
                    • 您應親自在指定地址收取藥物，若您基於任何原因無法親自接收，請確保接收藥物的人已年滿 18 歲並獲您正式授權，且能夠向指定送遞員出示或向其告知收件號碼。接收藥物的人透過能夠出示或告知您的收件號碼，即表示該指定送遞員應視收取藥物的人已年滿 18 歲，並獲正式授權代表您收取藥物，而毋須核實其身份。
                    </Text>
                   ...
                   私隱及安全
                    ...
                    <Text style={styles.greyPolicyText}>
                   責任聲明
                    • 您同意向德信醫療及相關醫生賠償因以下情況而招致的一切損失、成本、收費及包括合理律師費在內的開支；情況包括因 i)您未能及時、以及在臨床上認為適合的方式提供正確或／及完整的臨床資料／歷史；或 ii) 您隱瞞重要事實；或 iii) 您無法提供患者相關的臨床資料；或 iv) 您錯誤判斷我方所提供的建議／處方／診斷；或 v) 您未有遵從醫生提供的建議／處方，所導致的錯誤診斷／錯誤判斷／錯誤闡釋／錯誤理解。
                   ...
                   一般條款及細則
                    ...
                    • 您聲明並保證您已年過 18 歲並有能力及符合資格簽署具有法律約束力的協議。
                    </Text>
                    ...
                    <Text style={styles.greyPolicyText}>
                        香港銅鑼灣恩平道28號利園2期24/F 2401室  Unit 2401, 24/F., Lee Garden II, 28 Yan Ping Road, Causeway Bay, Hong Kong
                    </Text>
