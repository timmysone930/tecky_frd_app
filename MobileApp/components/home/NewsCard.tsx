        ...
        <>
            ...
            <View style={{ flexWrap: 'wrap', flexDirection: 'row', justifyContent: 'center' }}>
                <TouchableOpacity style={styles.newsCard}>
                    <Image resizeMode='contain' style={{ height:120, width:100, marginTop:10,}} source={require("../../images/news_test_01.jpeg")} />
                    <Text style={styles.cardDate}>12/11/2021</Text>
                    <Text style={styles.cardTitle}>抗體檢查測試</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.newsCard}>
                    <Image resizeMode='contain' style={{ height: 120, width:100, marginTop:10 }} source={require("../../images/news_test_02.jpeg")} />
